...
BOT_TOKEN = environ.get('BOT_TOKEN', "6906674371:AAH--GKbSTS6DE7f2eHiEDVNVxQiYfrqhc4")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/4a35175dba60c6d52e5d4.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/73eebc1ef349850cb22a6.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/85d361ab4cb6511006022.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/16cd37f214228d1f13a98.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/6c0807308c94bb00a195d.jpg'))
CODE = (environ.get('CODE', 'https://graph.org/file/8da3d270a231b7f78e9c7.jpg'))
...
SHORTLINK_API = environ.get('SHORTLINK_API', '46ae73ed25427bac1c44fd96f8c58331ae879703')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Dev77_xD')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Dev77_xD')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowToVerify_xD/5')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ʜᴀᴘᴘʏ ᴇɴᴊᴏʏᴍᴇɴᴛ ʙᴜᴅᴅʏ ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002029882072'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Dev77_xD')
